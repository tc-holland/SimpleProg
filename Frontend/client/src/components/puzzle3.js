...
const puzzleData = {
  ...
  words: ["return cleaned == cleaned[::-1", "def isPalindrome(str):", "if c.isalnum():", "cleaned += c", "for c in str.lower():", "cleaned = \"\""],
};
      ...
      <div className="bg">
        <div className="container">
          ...
          <div className="title">
            ...
            <p>Drag each code segment to the correct line to write a function that checks for palindromes in a word</p>
          </div>
